...
//______________________________________________________________my : hier need init global variables
  strcpy(banner, "220 %s FTP Ready\r\n");
  strcpy(badcmd, "500 Unknown command\r\n");
  strcpy(logged,"230 Logged in\r\n");
  strcpy(typeok, "200 Type OK\r\n");
  strcpy(badtype, "501 Unknown type \"%s\"\r\n");
  strcpy(badport,"501 Bad port syntax\r\n");
  strcpy(unimp,"502 Command not yet implemented\r\n");
  strcpy(bye, "221 Goodbye!\r\n");
  strcpy(cantopen,"550 Can't open file \"%s\"\r\n");
  strcpy(sending,"150 Opening data connection for %s (%s)\r\n");
  strcpy(portok, "200 Port command okay\r\n");
  strcpy(rxok,"226 File received OK - %ld bytes in %ld.%03ld sec\r\n");
  strcpy(txok, "226 File sent OK - %ld bytes in %ld.%03ld sec\r\n");

  strcpy(commands[0],"user");
  strcpy(commands[1],"acct");
  strcpy(commands[2],"pass");
  strcpy(commands[3],"type");
  strcpy(commands[4],"name");
  strcpy(commands[5],"quit");
  strcpy(commands[6],"port");
  strcpy(commands[7],"retr");
  strcpy(commands[8],"stor");
  strcpy(commands[9],"help");
  strcpy(commands[10],"abor");
  strcpy(commands[11],NULL);
