...
*** ARC International.
***
*** Comments:  This file contains the implementation of the UDP/IP
...
{ /* Body */
   ...
   uint_16 llen = sizeof(laddr);
      ...
      */
   xprt = (SVCXPRT_PTR)_mem_alloc_zero(sizeof(SVCXPRT));
   if (xprt == NULL) {
      ...
      */
   su = (SVC_UDP_PTR)_mem_alloc_zero(sizeof(SVC_UDP));
   if (su == NULL) {
      fprintf(stderr, "svcudp_create: out of memory\n");
      goto create_fail;
   } /* Endif */
