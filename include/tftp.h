...
*** File: tftp.h
***
*** Comments:  This file contains the definitions needed by TFTP.
***
************************************************************************
*END*******************************************************************/
...
// #define TFTP_DATA_SIZE           128 //t
#define TFTPSRV_MAX_TRANSACTIONS  20

#define TFTP_TIMEOUT_RETRIES    0        /* retransmit forever */
#define TFTP_TIMEOUT_MIN        4000     /* 4 seconds */
// #define TFTP_TIMEOUT_MIN        400000     /* t */
#define TFTP_TIMEOUT_MAX        60000    /* 1 minute */
// #define TFTP_TIMEOUT_MAX        6000000    /* t*/
...
typedef struct tftp_trans {
   struct tftp_trans _PTR_       NEXT;
   struct tftp_trans _PTR_ _PTR_ PREV;
   uint_32                       TIME;
   uint_32                       SOCK;
   FILE              _PTR_       FILE_PTR;
   sockaddr_in                   ADDR;
...
extern uint_32 TFTPSRV_open_device (uint_32, char_ptr, char_ptr, FILE_PTR _PTR_);
