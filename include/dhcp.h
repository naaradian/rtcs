...
** Error codes
*/
#define RTCSERR_DHCP_ALREADY_INIT           376
#define RTCSERR_DHCP_MESSAGE_OPTION_MISSING 377
#define RTCSERR_DHCP_SERVER_OPTION_MISSING  378
#define RTCSERR_DHCP_ADDR_IN_USE            379
