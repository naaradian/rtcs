...
//100402#define TCP_RTO_MIN  (TICK_LENGTH*3)  
//#define TCP_RTO_MIN  (TICK_LENGTH*5)  //091222
#define TCP_RTO_MIN  500 //100402  

 /* Wait at least two ticks before
...
#ifndef BIG_DELAY
#define TCP_ACKDELAY_DEFAULT      40  //my 091207   /* TCP_Delayed ack, in msecs: default */
#else //BIG_DELAY
#define TCP_ACKDELAY_DEFAULT      200   /* TCP_Delayed ack, in msecs: default */
#endif//BIG_DELAY


#define TCP_ACKDELAY_MAX         500   /* Max ack delay, as per RFC1122 */

/* would be used if TCP_ACKDELAY was configurable */
#define TCP_ACKDELAY      TCP_ACKDELAY_DEFAULT
                                       /* actual value used */
...
#define TCP_DROP     {tcp_cfg->STATS.ST_RX_DISCARDED++; /* Used in TCP_Service_packet*/ \
                      DEBUGTCP(printf("\nTCP_Service_packet: Dropping packet")); \
                      goto tcp_sp_drop; }

#define TCP_PP_DROP  {tcp_cfg->STATS.ST_RX_DISCARDED++; /* Used in TCP_Process_packet */ \
 ...
 */
typedef struct {              /* see RFC sec.3.1 */
