...
/* Error codes specific to DNS */

#define DNS_OK                              RTCS_OK

#define DNS_QUERY_OK                        0x900
#define DNS_NO_NAME_SERVER_RESPONSE         0x901
#define DNS_UNABLE_TO_OPEN_SOCKET           0x902
#define DNS_UNABLE_TO_BIND_SOCKET           0x903
#define DNS_UNABLE_TO_UPDATE_ROOT_SERVERS   0x904
#define DNS_SOCKET_RECV_ERROR               0x905
#define DNS_UNABLE_TO_SEND_QUERY            0x906
#define DNS_NO_RESPONSE_FROM_RESOLVER       0x907
#define DNS_PACKET_RECEPTION_ERROR          0x908
#define DNS_INVALID_NAME                    0x909
#define DNS_INVALID_IP_ADDR                 0x90A
#define DNS_ALL_SERVERS_QUERIED             0x90B
#define DNS_INVALID_LOCAL_NAME              0x90C
#define DNS_UNABLE_TO_ALLOCATE_MEMORY       0x90D
#define DNS_UNABLE_TO_FREE_SOCKET           0x90E
#define DNS_VALID_IP_ADDR                   0x90F
#define DNS_INITIALIZATION_FAILURE          0x910
#define DNS_NOT_IMPLEMENTED                 0x911
#define DNS_UNABLE_TO_CREATE_PARTITION      0x912
...
typedef struct dns_name_record {
   DNS_RR_HEADER_STRUCT             RR;
...
typedef struct dns_response_rr_middle {
...
typedef struct dns_message_head {
...
typedef struct dns_message_tail {
...
typedef struct dns_slist {

   uchar            _PTR_ NAME_PTR;
   struct dns_slist _PTR_ NEXT;
   _ip_address            IPADDR;
   uint_32                LAST_TTL_CHECK;
   int_32                 TTL;
...
typedef struct dns_canonical_name {
   uchar                     _PTR_ CNAME_PTR;
   struct dns_canonical_name _PTR_ NEXT;
...
typedef struct dns_internal_query {
   ...
   */
   ...
   struct dns_internal_query _PTR_ NEXT;
