#ifndef __rtcs24x_h__
#define __rtcs24x_h__
/*HEADER****************************************************************
************************************************************************
***
...
extern uint_32 RTCS_sem_trywait(_rtcs_sem _PTR_ p);
...
typedef struct {
   ...
   pointer           WAIT;    /* Task descriptor of a blocked receiver */
...
#define RTCS_task_destroy(x)  _task_destroy(((TD_STRUCT_PTR)(x))->TASK_ID)
