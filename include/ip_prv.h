...
/*
** Allocation blocks for IP interfaces, routes, and multicast group members
*/
...
/* WORK: jme- should i used one to say if it the loopback interface */
...
extern void IPIF_add1         (IPIF_PARM_PTR);
extern void IPIF_bdd1         (IPIF_PARM_PTR);

extern void IPIF_add2         (IPIF_PARM_PTR);
