...
*** File: bootp.c
***
*** Comments:  This file contains the implementation of the BOOTP client
...
{ /* Body */
   ...
   RTCSPCB_frag(pcb_ptr, sizeof(BOOTP_HEADER), (uchar_ptr)&bootp->PACKET);
   RTCSPCB_frag(pcb_ptr, sizeof(BOOTP_DATA),   parms->data->SNAME);
...
void BOOTP_service
   (
      RTCSPCB_PTR    pcb_ptr     /* [IN] BOOTREPLY packet */
   )
{ /* Body */
   ...
   bootreply = (BOOTP_PACKET_PTR)RTCSPCB_DATA(pcb_ptr);
   if (RTCSPCB_SIZE(pcb_ptr) < sizeof(BOOTP_PACKET)) {
