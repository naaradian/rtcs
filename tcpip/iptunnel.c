...
*** File: iptunnel.c
***
*** Comments:  This file contains the IP tunnel encapsulation functionnality.
***
************************************************************************
*END*******************************************************************/
...
{ /* Body */
   ...
   cfg = _mem_alloc_zero(sizeof(IPIP_CFG_STRUCT));
...
{ /* Body */
   ...
   /* Start CR 1057 */
#if 0
   /* Set DF flag in outer header if it's set in the inner header */
   if (ntohs(ip->FRAGMENT) & IP_FRAG_DF) {
      proto |= IPDF(1);
   } /* Endif */
#endif
   /* End CR */
