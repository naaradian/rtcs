...
*** File: ip_reasm.c
***
*** Comments:  This file contains the code to handle IP reassembly
***
************************************************************************
*END*******************************************************************/
...
{ /* Body */
   ...
   bpcb->PRIVATE = NULL;
   /* Start SPR P122-0266-23 remove all warnings from RTCS code. */
   /*bpcb->FRAG[0].LENGTH   = ip_totlen; */
   /*bpcb->FRAG[0].FRAGMENT = data;      */
   /*bpcb->FRAG[1].LENGTH   = 0;         */
   /*bpcb->FRAG[1].FRAGMENT = NULL;      */
