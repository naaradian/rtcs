...
{ /* Body */
   ...
   *outp++ = CHAP_CHALLENGE_LEN;
   ...
   PPP_memcopy(_PPP_CHAP_LNAME, outp, idlen);
...
{ /* Body */
   ...
   */
   ...
   case CHAP_CODE_CHALLENGE:
      ...
      secret = _PPP_CHAP_LSECRETS;
      inp = pcb->FRAG[0].FRAGMENT + 2;
      *inp++ = CHAP_CODE_RESPONSE;
      inp++;                           /* Keep same ID */
      namelen = strlen(_PPP_CHAP_LNAME);
      ...
      *inp++ = 16;
      ...
      inp += 16;
      PPP_memcopy(_PPP_CHAP_LNAME, inp, namelen);
