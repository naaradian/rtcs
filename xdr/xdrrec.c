...
*** ARC International.
***
*** Comments:  This file contains the implementation of the record
...
{ /* Body */
   register RECSTREAM_PTR rstrm =
      (RECSTREAM_PTR)_mem_alloc_zero(sizeof(RECSTREAM));
   ...
   */
   ...
   rstrm->the_buffer = (caddr_t)_mem_alloc_zero(sendsize + recvsize);
