...
*** ARC International.
***
*** Comments:  This file contains the implementation of the generic
...
{ /* Body */
   ...
   case XDR_DECODE:
      if (cp == NULL) {
         cp = (caddr_t)_mem_alloc_zero(count);
         if (cp == NULL) {
...
{ /* Body */
   ...
   case XDR_DECODE:
      ...
      if (cp == NULL) {
         cp = (char_ptr)_mem_alloc_zero(size);
         if (cp == NULL) {
...
{ /* Body */
   ...
   case XDR_DECODE:
      if (objp == NULL) {
         objp = (caddr_t)_mem_alloc_zero(size);
         if (objp == NULL) {
